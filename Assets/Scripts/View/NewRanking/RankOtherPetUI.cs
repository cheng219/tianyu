...
public class RankOtherPetUI : MonoBehaviour {

    #region 宠物
    //public UIToggle petTog;
    //public UIToggle mountTog;
    ...
    void OnEnable()
    {
        ...
        GameCenter.previewManager.OnGotRankOtherPetInfo -= RefreshAll;
        GameCenter.previewManager.OnGotRankOtherPetInfo += RefreshAll;
        RefreshAll();
    }
    void OnDisable()
    ...
    void ShowPetInfo()
    {
        ...
        //if (labPetLv != null) labPetLv.text = curTargetInfo.CurPetInfo.Level.ToString();
