...
namespace YunvaIM
{
    ...
    public class YunVaImInterface : MonoSingleton<YunVaImInterface>
    {
        ...
        {
            Debug.Log(context + ":" + appid + ":" + path + ":" + isTest);
            return YVIM_Init(CallBack, context, appid, path, isTest);
        }
...
#endif
        private static extern int YVIM_Init(YvCallBack callback, uint context, uint appid, string path, bool test);
