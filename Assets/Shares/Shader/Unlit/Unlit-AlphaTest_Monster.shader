...
Shader "Unlit/Transparent Cutout Monster" {
Properties {
...
//				col.rgb = col.rgb * _OverlayColor.rgb*(1-msk.a)*_OverlayColor.a
//				+col.rgb*msk.a
//				+col.rgb*(1-msk.a)*(1-_OverlayColor.a);

//				col.rgb = col.rgb * _OverlayColor.rgb*msk.a*_OverlayColor.a
//				+col.rgb*(1-msk.a)
//				+col.rgb*msk.a*(1-_OverlayColor.a);

				col.rgb = col.rgb * _OverlayColor.rgb*msk.a*_OverlayColor.a
				+col.rgb*(1-msk.a*_OverlayColor.a);
