...
// 		Debug.Log("Duration.InitCloneObject");
		...
		if (m_ClonObject == null)
		{
			...
			// Remove Dup
			if(m_ClonObject != null){NcDuplicator durCom = m_ClonObject.GetComponent<NcDuplicator>();
			if (durCom != null)
//				DestroyImmediate(durCom);
			...
			if(m_ClonObject != null){NcDelayActive delCom = m_ClonObject.GetComponent<NcDelayActive>();
			if (delCom != null)
