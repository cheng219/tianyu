...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetMaskLayer", _m_SetMaskLayer);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetMaskLayer(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetMaskLayer( _layer );
        ...
        static int _m_SetColor(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetColor( _color );
