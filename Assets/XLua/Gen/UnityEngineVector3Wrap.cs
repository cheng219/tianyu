...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector3Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Vector3), L, translator, 6, 9, 6, 3);
            ...
            try {
                
                {
                    float x = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector3 __cl_gen_ret = __cl_gen_to_be_invoked.SetX( x );
                        translator.PushUnityEngineVector3(L, __cl_gen_ret);
            ...
            try {
                
                {
                    float z = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector3 __cl_gen_ret = __cl_gen_to_be_invoked.SetZ( z );
                        translator.PushUnityEngineVector3(L, __cl_gen_ret);
