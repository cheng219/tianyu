    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(GameStageUtility), GameStageUtilityWrap.__Register);
				
				translator.DelayWrapLoader(typeof(GameStage), GameStageWrap.__Register);
				
				translator.DelayWrapLoader(typeof(UnityEngineExtends), UnityEngineExtendsWrap.__Register);
